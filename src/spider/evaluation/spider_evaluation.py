...
def print_scores(scores, etype, print_stdout):
...
def spider_eval(gold, predict, db_dir, etype, kmaps, print_stdout=True):
    ...
    return print_scores(scores, etype, print_stdout)
...
def eval_exec_match(db, p_str, g_str, pred, gold):
    ...
    def res_map(res, val_units):
        """
        Notes Aadhil: The val_units are the columns in the select and "res" is the results from the select, one tuple per row.
...
if __name__ == "__main__":
    ...
    spider_eval(gold, pred, db_dir, etype, kmaps)
